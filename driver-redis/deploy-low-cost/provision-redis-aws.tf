...
resource "aws_elasticache_user" "redis_benchmark_cluster_user" {
  user_id       = "redis-user-${random_id.hash.hex}"
...
resource "local_file" "tf_ansible_vars_file" {
  content = <<-DOC
    ...
    tf_redis_username: ${var.redis_username}
    tf_redis_password: ${var.redis_password}
    DOC

...
export function addMonitoring(stack: Stack, queue: IQueue, lambda: LambdaFunction, deadLetterQueue: IQueue, snsDeadLetterQueue: IQueue, props: S3ConsumerLambdaStackProps, id: string) {
